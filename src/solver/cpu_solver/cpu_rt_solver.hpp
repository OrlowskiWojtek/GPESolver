#ifndef CPU_RT_GPE_SOLVER
#define CPU_RT_GPE_SOLVER

#include "solver/solver.hpp"

class CpuRTGrossPitaevskiSolver : public AbstractGrossPitaevskiSolver {
public:
    CpuRTGrossPitaevskiSolver(AbstractSimulationMediator *mediator);
