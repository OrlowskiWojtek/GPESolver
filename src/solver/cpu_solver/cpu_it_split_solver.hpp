#ifndef CPU_IMAGINARY_SPLIT_GPE_SOLVER
#define CPU_IMAGINARY_SPLIT_GPE_SOLVER

#include "solver/solver.hpp"

class CpuITSplitGrossPitaevskiSolver : public AbstractGrossPitaevskiSolver {
public:
    CpuITSplitGrossPitaevskiSolver(AbstractSimulationMediator *mediator);

private:
    CPUSolverData m_data;

    std::unique_ptr<AbstractPoissonSolver> poisson_solver;
    std::unique_ptr<AbstractRealTimeSplitSolver> rt_imag_split_solver;
    ...
    void imag_fft_potential_half_step();
    void imag_fft_kinetic_step();
};
