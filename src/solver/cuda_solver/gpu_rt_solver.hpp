#ifndef GPU_REAL_GPE_SOLVER
#define GPU_REAL_GPE_SOLVER

#include "solver/solver.hpp"
#include "solver/solver_data/gpu_solver_data.hpp"

class GpuRTGrossPitaevskiSolver : public AbstractGrossPitaevskiSolver {
public:
    GpuRTGrossPitaevskiSolver(AbstractSimulationMediator *mediator);
    ~GpuRTGrossPitaevskiSolver();
